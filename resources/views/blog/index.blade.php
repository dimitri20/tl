    ...
    <div class="section-outer-container">
        <div class="container">
            <div  class="text-center">
                ...
                <h2 class="title-align-center">ბლოგი</h2>

                <main class="my-5">
                    <div class="container">
                        <div class="text-center">
                            @if (sizeof($posts) > 0)
                                <h4 class="mb-5"><strong>უახლესი პოსტები</strong></h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12 mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="/blog/{{ $posts[3*$i+$j]->id }}" class="btn btn-primary">Read</a>
                                            </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-12 mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="/blog/{{ $posts[3*(floor(sizeof($posts)/3))+$j]->id }}" class="btn btn-primary">Read</a>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <h4 class="mb-5"><strong>პოსტები ჯერ არ არის</strong></h4>
